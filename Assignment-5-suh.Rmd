...
stacked_bar <- ggplot(stacked_bar_data, aes(x = year, y = degrees_awarded, fill = field_of_study)) +
  ...
  annotate("text", x = 1, y = 2100, label = "3.5%", family = "Century Schoolbook") +
...
wsr_salaries_np
# p = 0.002572
# this tells us to reject null. There is significant diff between male and female non post doc positions aong field of study. 
